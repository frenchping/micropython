...
// D0/D1      LPUART2 -> 1      // PING: Moved to GPIO_EMC_22/23
// D6/D9      LPUART3 -> 2
// D10/D12    LPUART5 -> 3
// D14/D15    LPUART8 -> 4
// A0/A1      LPUART4 -> 5
...
#define MICROPY_HW_UART_INDEX   { 1, 2, 3, 5, 8, 4, 7 }

#define IOMUX_TABLE_UART \
    { IOMUXC_GPIO_AD_B0_06_LPUART1_TX }, { IOMUXC_GPIO_AD_B0_07_LPUART1_RX }, \
    { IOMUXC_GPIO_EMC_22_LPUART2_TX }, { IOMUXC_GPIO_EMC_23_LPUART2_RX }, \
    { IOMUXC_GPIO_EMC_06_LPUART3_TX }, { IOMUXC_GPIO_EMC_07_LPUART3_RX }, \
    ...
    { 0 }, { 0 }, \
    { IOMUXC_GPIO_SD_B0_04_LPUART7_TX }, { IOMUXC_GPIO_SD_B0_05_LPUART7_RX }, \
...
// D14/D15  LPI2C4 ->    0
// A4/A5    LPI2C1 ->    1
// D0/D1    LPI2C2 ->    2      // PING: Moved to GPIO_EMC_19/18
...
// PING: Remap all the pins to GPIO_EMC_xx
#define I2S_GPIO_MAP \
    { \
...
#if 0
// PING: Disable USDHC1 and Enable USDHC2
...
#define MICROPY_USDHC2 \
    { \
        .cmd = {GPIO_SD_B1_02_USDHC2_CMD}, \
        .clk = { GPIO_SD_B1_03_USDHC2_CLK }, \
        .cd_b = { GPIO_SD_B1_06_USDHC2_CD_B }, \
        .data0 = { GPIO_SD_B1_04_USDHC2_DATA0 }, \
        .data1 = { GPIO_SD_B1_05_USDHC2_DATA1 }, \
        .data2 = { GPIO_SD_B1_00_USDHC2_DATA2 }, \
        .data3 = { GPIO_SD_B1_01_USDHC2_DATA3 }, \
    }
#endif  // No USDHC

#if 0   // PING: Disable SDRAM & ENET
// --- SEMC --- //
